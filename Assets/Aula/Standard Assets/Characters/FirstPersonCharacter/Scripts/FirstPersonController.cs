...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        bool IsGrounded => m_CharacterController.isGrounded || m_Hooked;

        //bool IsGrounded
        //{
        //    get
        //    {
        //        return m_CharacterController.isGrounded || m_Hooked;
        //    }
        //}
        ...
        void OnPlatformUnhook()
        {
            m_Hooked = false;
        }

        void OnPlatformMove(Vector3 movement)
        {
        ...
        private void RotateView()
        {
            ...
            {
                //print("Girando " + Input.GetAxis("Turn"));
